...
class BayesianQFunctionFactory(QFunctionFactory):
    """Bayesian Q function factory class.
    ...
    def create_discrete(self, encoder: Encoder, action_size: int) -> DiscreteBayesianQFunction:
    ...
    def create_continuous(self, encoder: EncoderWithAction) -> ContinuousBayesianQFunction:
        return ContinuousBayesianQFunction(encoder, self._n_quantiles, self.Vmin, self.Vmax, self.weight_penalty, self.weight_R, self.weight_A, self.n_neg_samples)
...
class C51QFunctionFactory(QFunctionFactory):
    """C51 Q function factory class.
    ...
    def create_discrete(
        ...
        return DiscreteC51QFunction(encoder, action_size, self._n_quantiles)
...
register_q_func_factory(BayesianQFunctionFactory)
register_q_func_factory(C51QFunctionFactory)
